...
describe("CardBusiness", () => {
    ...
    describe("registerCard", () => {
        test("should return 'Missing parameters' to cardNumber empty", (done) => {
            const cardBusiness = new CardBusiness_1.CardBusiness(new CardDatabase(), new HashManager(), new Authenticator(), new IdGenerator(), new LuhnCheckAlgorithm());
            cardBusiness
    ...
    describe("Card model", () => {
        test("Should return mocked payment data correctly using getters", () => {
            const card = new Card_1.Card("5555666677778884", "Bruno", "05/32", 333, "Mastercard");
            const result = {
